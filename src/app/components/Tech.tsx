    ...
    <>
      ...
      <div className="flex items-center flex-wrap justify-center mb-20">
        <div className="w-4/5 overflow-y-auto align-middle flex items-center flex-wrap justify-center">
          <Tooltip title="HTML5">
            <div className="rounded-full bg-violet-600 h-24 w-24 mx-2 hover:bg-violet-900 transition duration-300 flex items-center flex-wrap justify-center p-3">
          ...
          <Tooltip title="Next.js">
            <div className="rounded-full bg-violet-600 h-24 w-24 mx-2 hover:bg-violet-900 transition duration-300 flex items-center flex-wrap justify-center">
              <img
