...
export default function About() {
  const [textSize, setTextSize] = useState<string | null>(null);
    ...
    return (
      <div className="mt-32 flex items-center flex-wrap justify-center px-4 sm:px-6 md:px-8">
        <div className="w-full sm:w-1/2 lg:w-5/12 text-center sm:text-left sm:pr-8 mb-8 sm:mb-0">
          <p className="font-bold leading-tight text-7xl sm:text-5xl md:text-4xl lg:text-5xl">Olá, eu sou o</p>
          <p className="font-bold text-violet-600 leading-tight text-7xl sm:text-5xl md:text-4xl lg:text-5xl">Caio Cintra</p>
